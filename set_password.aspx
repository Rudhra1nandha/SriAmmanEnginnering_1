<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="set_password.aspx.cs" Inherits="SriAmmanEngineeringAndWorks_ASPDotNet.set_password" %>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-8 mx-auto col-12">
                            ...
                            <h1 class="hero-title text-center mb-5">Set Password </h1>
                                ...
                                <div class="col-lg-8 col-11 mx-auto">
                                    <form role="form" method="post" runat="server">
                                        ...
                                        <div class="form-floating mb-4 p-0">
                                             ...
                                             <asp:TextBox type="email" name="email" ID="txt_password" class="form-control" placeholder="Enter new password"  runat="server"></asp:TextBox>
                                        ...
                                        <div class="form-floating p-0">
                                             ...
                                             <asp:TextBox type="password" name="password" ID="txt_cpassword" class="form-control" placeholder="Enter Confirm Password" runat="server"></asp:TextBox>
